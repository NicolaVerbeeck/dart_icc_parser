...
void main() {
  ...
  group('DataStream tests', () {
    ...
    test('Test readDataTime', () {
      final stream = dataStreamOf(_dateTimeData);
    ...
    test('Test read bytes', () {
      final stream = dataStreamOf([0x01, 0x02, 0x03, 0x04, 0x05]);
      stream.seek(1);
...
DataStream dataStreamOf(List<int> bytes) {
